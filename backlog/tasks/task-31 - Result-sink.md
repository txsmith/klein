...
Constraint from edition serialization: whatever the sink contributes to compilation must land in the edition stored form (a pin or a field), or pin-based re-derivation silently reproduces the wrong program.
