...
> **Status (2026-06-24): stale.** Tied to the SimpleSub constraint solver, which Path G removes. Kept for historical context. See [decisions/2026-06-24-adopt-path-g.md](../decisions/2026-06-24-adopt-path-g.md).
