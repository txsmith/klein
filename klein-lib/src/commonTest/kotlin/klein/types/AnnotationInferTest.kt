...
class AnnotationInferTest {
    ...
    @Test
    fun typeVar_localBindingConstrainedByFunctionScope() {
        // 'A from param, used in local binding — local val has the param's type
        assertType(
            "(Num) -> Num",
            infer(
                """
    ...
    @Test
    fun recordField_lambdaAnnotation_bodyCannotConstrainTypeVar() {
